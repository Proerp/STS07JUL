...
{
    public class ListCategoryDetail : NotifyPropertyChangeObject
    {
        ...
        public int CommonID
        {
            ...
            set { ApplyPropertyChange<ListCategoryDetail, int>(ref this.commonID, o => o.CommonID, value); }
        }
        ...
        public double CommonValue
        {
            ...
            set
            {
                ...
                ApplyPropertyChange<ListCategoryDetail, double>(ref this.commonValue, o => o.CommonValue, value);
            }
        }
        ...
        public string Remarks
        {
            ...
            set { ApplyPropertyChange<ListCategoryDetail, string>(ref this.remarks, o => o.Remarks, value); }
        }
