...
{
    public class ListCoilDetail : NotifyPropertyChangeObject
    {
        ...
        public ListCoilDetail()
            : this(0, 0, "")
        {
        }

        public ListCoilDetail(int commonID, double commonValue, string remarks)
        {
        ...
        public int CommonID
        {
            ...
            set { ApplyPropertyChange<ListCoilDetail, int>(ref this.commonID, o => o.CommonID, value); }
        }
        ...
        public double CommonValue
        {
            ...
            set
            {
                ...
                ApplyPropertyChange<ListCoilDetail, double>(ref this.commonValue, o => o.CommonValue, value);
            }
        }
        ...
        public string Remarks
        {
            ...
            set { ApplyPropertyChange<ListCoilDetail, string>(ref this.remarks, o => o.Remarks, value); }
        }
