...
{
    public class ListFactoryDetail : NotifyPropertyChangeObject
    {
        ...
        public ListFactoryDetail()
            : this(0, 0, "")
        {
        }

        public ListFactoryDetail(int commonID, double commonValue, string remarks)
        {
        ...
        public int CommonID
        {
            ...
            set { ApplyPropertyChange<ListFactoryDetail, int>(ref this.commonID, o => o.CommonID, value); }
        }
        ...
        public double CommonValue
        {
            ...
            set
            {
                ...
                ApplyPropertyChange<ListFactoryDetail, double>(ref this.commonValue, o => o.CommonValue, value);
            }
        }
        ...
        public string Remarks
        {
            ...
            set { ApplyPropertyChange<ListFactoryDetail, string>(ref this.remarks, o => o.Remarks, value); }
        }
