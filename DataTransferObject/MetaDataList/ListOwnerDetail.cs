...
{
    public class ListOwnerDetail : NotifyPropertyChangeObject
    {
        ...
        public ListOwnerDetail()
            : this(0, 0, "")
        {
        }

        public ListOwnerDetail(int commonID, double commonValue, string remarks)
        {
        ...
        public int CommonID
        {
            ...
            set { ApplyPropertyChange<ListOwnerDetail, int>(ref this.commonID, o => o.CommonID, value); }
        }
        ...
        public double CommonValue
        {
            ...
            set
            {
                ...
                ApplyPropertyChange<ListOwnerDetail, double>(ref this.commonValue, o => o.CommonValue, value);
            }
        }
        ...
        public string Remarks
        {
            ...
            set { ApplyPropertyChange<ListOwnerDetail, string>(ref this.remarks, o => o.Remarks, value); }
        }
