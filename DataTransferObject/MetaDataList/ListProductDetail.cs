...
{
    public class ListProductDetail : NotifyPropertyChangeObject
    {
        ...
        public ListProductDetail(int commonID, double commonValue, string remarks)
        {
        ...
        public int CommonID
        {
            ...
            set { ApplyPropertyChange<ListProductDetail, int>(ref this.commonID, o => o.CommonID, value); }
        }
        ...
        public double CommonValue
        {
            ...
            set
            {
                ...
                ApplyPropertyChange<ListProductDetail, double>(ref this.commonValue, o => o.CommonValue, value);
            }
        }
        ...
        public string Remarks
        {
            ...
            set { ApplyPropertyChange<ListProductDetail, string>(ref this.remarks, o => o.Remarks, value); }
        }
