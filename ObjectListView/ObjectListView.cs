...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        protected virtual bool ProcessLButtonDown(OlvListViewHitTestInfo hti) {
            ...
            if (hti.Column.Index > 0) {
                ...
                this.SelectedIndex = -1; //Added by Le Minh Hiep - 0919 878 329 - Date: 10/04/2013: To make it redraw after subitemclick
                this.SelectedItem = hti.Item; //Added by Le Minh Hiep - 0919 878 329 - Date: 10/04/2013: To make it redraw after subitemclick
