...
{
    public partial class ListEmployee : Form, IMergeToolStrip, ICallToolStrip
    {
        ...
        {
            get { return this.listEmployeeBLL.TaskID; }
        }
        ...
        public bool IsDirty
        {
            get { return this.listEmployeeBLL.IsDirty; }
        }

        public bool IsValid
        {
            get { return this.listEmployeeBLL.IsValid; }
        }
        ...
        public bool Newable
        {
            get { return !this.listEmployeeBLL.ReadOnly; }
        }
        ...
        {
            get { return this.listEmployeeBLL.Editable; }
        }
        ...
        {
            get { return this.listEmployeeBLL.Verifiable; }
        }

        public bool Unverifiable
        {
            get { return this.listEmployeeBLL.Unverifiable; }
        }
        ...
        private void SetEditableMode(bool editableMode)
        {
            ...
            {
                this.lastAddressAreaID = this.listEmployeeBLL.EmployeeID;
        ...
        private void CancelDirty(bool restoreSavedData)
        {
            try
            {
                if (restoreSavedData || this.listEmployeeBLL.EmployeeID <= 0)
                    this.listEmployeeBLL.Fill(this.lastAddressAreaID);
        ...
        public void Save()
        {
            this.listEmployeeBLL.Save();
            this.GetMasterList();
        }

        public void Delete()
        {
            DialogResult dialogResult = MessageBox.Show(this, "Bạn muốn xóa dữ liệu này " + this.listEmployeeBLL.ListEmployeeMaster.Description + "?", "Cảnh báo", MessageBoxButtons.YesNo, MessageBoxIcon.Stop);
            if (dialogResult == DialogResult.Yes)
            {
                try
                {
                    this.listEmployeeBLL.Delete();
                    this.GetMasterList();
                }
                catch (Exception exception)
                {
        ...
        #region <Storage>
        private ListEmployeeBLL listEmployeeBLL;
        ...
        public ListEmployee()
        {
            try
            {
                ...
                this.listEmployeeBLL = new ListEmployeeBLL();

                this.listEmployeeBLL.PropertyChanged += new PropertyChangedEventHandler(listEmployeeBLL_PropertyChanged);
        ...
        void listEmployeeBLL_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        {
            this.descriptionBinding = this.textBoxDescription.DataBindings.Add("Text", this.listEmployeeBLL.ListEmployeeMaster, "Description", true);
            this.remarksBinding = this.textBoxRemarks.DataBindings.Add("Text", this.listEmployeeBLL.ListEmployeeMaster, "Remarks", true);

            this.isDirtyBinding = this.checkBoxIsDirty.DataBindings.Add("Checked", this.listEmployeeBLL.ListEmployeeMaster, "IsDirty", true);
            this.isDirtyBLLBinding = this.checkBoxIsDirtyBLL.DataBindings.Add("Checked", this.listEmployeeBLL, "IsDirty", true);
            ...
            this.errorProviderMaster.DataSource = this.listEmployeeBLL.ListEmployeeMaster;
        }
        ...
        private void GetMasterList()
        {
            ...
            DataTable dataTableEmployeeListing = this.listEmployeeBLL.ListEmployeeListing();
            dataTableEmployeeListing.TableName = "ListEmployeeListing";

            DataSet bindingDataSet = new DataSet();
            bindingDataSet.Tables.Add(dataTableEmployeeListing);

            this.dataListViewMaster.AutoGenerateColumns = false;
            this.dataListViewMaster.DataSource = dataTableEmployeeListing;
        ...
        BindingListView<ListEmployeeDetail> listAddressAreaDetailView;
        ...
        private void dataListViewMaster_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (row != null)
                {
                    ...
                    if (int.TryParse(row.Row["EmployeeID"].ToString(), out employeeID)) this.listEmployeeBLL.Fill(employeeID);
                    else this.listEmployeeBLL.Fill(0);
                }
                else this.listEmployeeBLL.Fill(0);
            }
            catch (Exception exception)
