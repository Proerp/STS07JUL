...
{
    public partial class ListLogo : Form, IMergeToolStrip, ICallToolStrip
    {
        ...
        {
            get { return this.listLogoBLL.TaskID; }
        }
        ...
        public bool IsDirty
        {
            get { return this.listLogoBLL.IsDirty; }
        }

        public bool IsValid
        {
            get { return this.listLogoBLL.IsValid; }
        }
        ...
        public bool Newable
        {
            get { return !this.listLogoBLL.ReadOnly; }
        }
        ...
        {
            get { return this.listLogoBLL.Editable; }
        }
        ...
        {
            get { return this.listLogoBLL.Verifiable; }
        }

        public bool Unverifiable
        {
            get { return this.listLogoBLL.Unverifiable; }
        }
        ...
        private void SetEditableMode(bool editableMode)
        {
            ...
            {
                this.lastAddressAreaID = this.listLogoBLL.LogoID;
        ...
        private void CancelDirty(bool restoreSavedData)
        {
            try
            {
                if (restoreSavedData || this.listLogoBLL.LogoID <= 0)
                    this.listLogoBLL.Fill(this.lastAddressAreaID);
        ...
        public void Save()
        {
            this.listLogoBLL.Save();
            this.GetMasterList();
        }

        public void Delete()
        {
            DialogResult dialogResult = MessageBox.Show(this, "Bạn muốn xóa dữ liệu này " + this.listLogoBLL.ListLogoMaster.Description + "?", "Cảnh báo", MessageBoxButtons.YesNo, MessageBoxIcon.Stop);
            if (dialogResult == DialogResult.Yes)
            {
                try
                {
                    this.listLogoBLL.Delete();
                    this.GetMasterList();
                }
                catch (Exception exception)
                {
        ...
        #region <Storage>
        private ListLogoBLL listLogoBLL;
        ...
        public ListLogo()
        {
            try
            {
                ...
                this.listLogoBLL = new ListLogoBLL();

                this.listLogoBLL.PropertyChanged += new PropertyChangedEventHandler(listLogoBLL_PropertyChanged);
        ...
        void listLogoBLL_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            this.NotifyPropertyChanged(e.PropertyName);
        }


        private void ListLogo_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            this.descriptionBinding = this.textBoxDescription.DataBindings.Add("Text", this.listLogoBLL.ListLogoMaster, "Description", true);
            this.logoGeneratorBinding = this.textBoxLogoGenerator.DataBindings.Add("Text", this.listLogoBLL.ListLogoMaster, "LogoGenerator", true);
            this.remarksBinding = this.textBoxRemarks.DataBindings.Add("Text", this.listLogoBLL.ListLogoMaster, "Remarks", true);

            this.isDirtyBinding = this.checkBoxIsDirty.DataBindings.Add("Checked", this.listLogoBLL.ListLogoMaster, "IsDirty", true);
            this.isDirtyBLLBinding = this.checkBoxIsDirtyBLL.DataBindings.Add("Checked", this.listLogoBLL, "IsDirty", true);
            ...
            this.errorProviderMaster.DataSource = this.listLogoBLL.ListLogoMaster;
        }
        ...
        private void GetMasterList()
        {
            ...
            DataTable dataTableLogoListing = this.listLogoBLL.ListLogoListing();
            dataTableLogoListing.TableName = "ListLogoListing";

            DataSet bindingDataSet = new DataSet();
            bindingDataSet.Tables.Add(dataTableLogoListing);

            this.dataListViewMaster.AutoGenerateColumns = false;
            this.dataListViewMaster.DataSource = dataTableLogoListing;
        ...
        BindingListView<ListLogoDetail> listAddressAreaDetailView;
        ...
        private void dataListViewMaster_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (row != null)
                {
                    ...
                    if (int.TryParse(row.Row["LogoID"].ToString(), out logoID)) this.listLogoBLL.Fill(logoID);
                    else this.listLogoBLL.Fill(0);
                }
                else this.listLogoBLL.Fill(0);
            }
            catch (Exception exception)
