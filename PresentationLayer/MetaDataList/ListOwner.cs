...
{
    public partial class ListOwner : Form, IMergeToolStrip, ICallToolStrip
    {
        ...
        {
            get { return this.listOwnerBLL.TaskID; }
        }
        ...
        public bool IsDirty
        {
            get { return this.listOwnerBLL.IsDirty; }
        }

        public bool IsValid
        {
            get { return this.listOwnerBLL.IsValid; }
        }
        ...
        public bool Newable
        {
            get { return !this.listOwnerBLL.ReadOnly; }
        }
        ...
        {
            get { return this.listOwnerBLL.Editable; }
        }
        ...
        {
            get { return this.listOwnerBLL.Verifiable; }
        }

        public bool Unverifiable
        {
            get { return this.listOwnerBLL.Unverifiable; }
        }
        ...
        private void SetEditableMode(bool editableMode)
        {
            ...
            {
                this.lastAddressAreaID = this.listOwnerBLL.OwnerID;
        ...
        private void CancelDirty(bool restoreSavedData)
        {
            try
            {
                if (restoreSavedData || this.listOwnerBLL.OwnerID <= 0)
                    this.listOwnerBLL.Fill(this.lastAddressAreaID);
        ...
        public void Save()
        {
            this.listOwnerBLL.Save();
            this.GetMasterList();
        }

        public void Delete()
        {
            DialogResult dialogResult = MessageBox.Show(this, "Bạn muốn xóa dữ liệu này " + this.listOwnerBLL.ListOwnerMaster.Description + "?", "Cảnh báo", MessageBoxButtons.YesNo, MessageBoxIcon.Stop);
            if (dialogResult == DialogResult.Yes)
            {
                try
                {
                    this.listOwnerBLL.Delete();
                    this.GetMasterList();
                }
                catch (Exception exception)
                {
        ...
        #region <Storage>
        private ListOwnerBLL listOwnerBLL;
        ...
        public ListOwner()
        {
            try
            {
                ...
                this.listOwnerBLL = new ListOwnerBLL();

                this.listOwnerBLL.PropertyChanged += new PropertyChangedEventHandler(listOwnerBLL_PropertyChanged);
        ...
        void listOwnerBLL_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            this.NotifyPropertyChanged(e.PropertyName);
        }


        private void ListOwner_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            this.descriptionBinding = this.textBoxDescription.DataBindings.Add("Text", this.listOwnerBLL.ListOwnerMaster, "Description", true);
            this.logoGeneratorBinding = this.textBoxLogoGenerator.DataBindings.Add("Text", this.listOwnerBLL.ListOwnerMaster, "LogoGenerator", true);
            this.remarksBinding = this.textBoxRemarks.DataBindings.Add("Text", this.listOwnerBLL.ListOwnerMaster, "Remarks", true);

            this.isDirtyBinding = this.checkBoxIsDirty.DataBindings.Add("Checked", this.listOwnerBLL.ListOwnerMaster, "IsDirty", true);
            this.isDirtyBLLBinding = this.checkBoxIsDirtyBLL.DataBindings.Add("Checked", this.listOwnerBLL, "IsDirty", true);
            ...
            this.errorProviderMaster.DataSource = this.listOwnerBLL.ListOwnerMaster;
        }
        ...
        private void GetMasterList()
        {
            ...
            DataTable dataTableOwnerListing = this.listOwnerBLL.ListOwnerListing();
            dataTableOwnerListing.TableName = "ListOwnerListing";

            DataSet bindingDataSet = new DataSet();
            bindingDataSet.Tables.Add(dataTableOwnerListing);

            this.dataListViewMaster.AutoGenerateColumns = false;
            this.dataListViewMaster.DataSource = dataTableOwnerListing;
        ...
        BindingListView<ListOwnerDetail> listAddressAreaDetailView;
        ...
        private void dataListViewMaster_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (row != null)
                {
                    ...
                    if (int.TryParse(row.Row["OwnerID"].ToString(), out ownerID)) this.listOwnerBLL.Fill(ownerID);
                    else this.listOwnerBLL.Fill(0);
                }
                else this.listOwnerBLL.Fill(0);
            }
            catch (Exception exception)
